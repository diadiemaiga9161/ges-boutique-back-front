...
import { Input, Directive, InjectionToken, Inject, Injectable, NgModule } from '@angular/core';
import Highmaps from 'highcharts/esm/highmaps.src';
import Highstock from 'highcharts/esm/highstock.src';
import Highcharts$1 from 'highcharts/esm/highcharts-gantt.src';

class Chart {
    options;
    refSubject = new AsyncSubject();
...
class ChartDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.1", ngImport: i0, type: ChartDirective, deps: [{ token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.0.1", type: ChartDirective, isStandalone: false, selector: "[chart]", inputs: { chart: "chart" }, usesOnChanges: true, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.1", ngImport: i0, type: ChartDirective, decorators: [{
            type: Directive,
            args: [{
                    selector: '[chart]',
                    standalone: false
    ...
    initModules() {
        this.chartModules.forEach(chartModule => {
            ...
            if (moduleFunc && typeof moduleFunc === 'function') {
                [Highcharts, Highstock, Highmaps, Highcharts$1].forEach(moduleFunc);
            }
        });
    }
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.1", ngImport: i0, type: ChartService, deps: [{ token: HIGHCHARTS_MODULES }], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.0.1", ngImport: i0, type: ChartService });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.1", ngImport: i0, type: ChartService, decorators: [{
            type: Injectable
...
class ChartModule {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.1", ngImport: i0, type: ChartModule, deps: [{ token: ChartService }], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.0.1", ngImport: i0, type: ChartModule, declarations: [ChartDirective], exports: [ChartDirective] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.0.1", ngImport: i0, type: ChartModule, providers: [
            { provide: HIGHCHARTS_MODULES, useValue: [] },
            ChartService
        ] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.1", ngImport: i0, type: ChartModule, decorators: [{
            type: NgModule,
            args: [{
        ...
        }], ctorParameters: () => [{ type: ChartService }] });
